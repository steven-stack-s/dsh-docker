...
[![DeepSeek Harness](https://img.shields.io/badge/DeepSeek%20Harness-0.1.7--alpha.2-4aa3ff)](https://github.com/deepseek-ai/deepseek-harness)
...
Release history in [CHANGELOG.md](CHANGELOG.md). Image tags follow the dual-version scheme `v<project-version>-dsh-<dsh-version>` (e.g. `v0.5.2-dsh-0.1.7-alpha.2`); pushing a tag in that format auto-builds multi-arch images to `ghcr.io`.
