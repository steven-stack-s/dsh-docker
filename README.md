...
Release history in [CHANGELOG.md](CHANGELOG.md). Image tags follow the dual-version scheme `v<project-version>-dsh<dsh-version>` (e.g. `v0.4.1-dsh0.1.5-rc.2`); pushing a tag in that format auto-builds multi-arch images to `ghcr.io`.
